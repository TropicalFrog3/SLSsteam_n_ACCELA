...
class UIStateManager:
    ...
    def _reload_movies(self):
        ...
        default_gif_path = resource_path("res/gif/main.gif")

        ui_mode = self.settings.value("ui_mode", "default")
        sonic_main_applied = False
        if ui_mode == "sonic":
            sonic_gif = resource_path("res/sonic/gifs/main.gif")
    ...
    def apply_style_settings(self):
        ...
        if ui_mode == "sonic":
            ...
            font_file = self.settings.value("font-file", "res/sonic/sonic-1-hud-font.otf")
    ...
    def switch_to_download_gif(self):
        ...
        ui_mode = self.settings.value("ui_mode", "default")
        if ui_mode == "sonic":
            sonic_dir = resource_path("res/sonic/gifs")
            sonic_downloads = []
