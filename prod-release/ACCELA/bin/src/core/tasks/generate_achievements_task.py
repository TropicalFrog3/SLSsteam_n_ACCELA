...
from utils.helpers import resource_path, get_base_path, is_running_in_pyinstaller, get_venv_python, _get_slscheevo_path, _ensure_template_file, _get_slscheevo_save_path
...
class GenerateAchievementsTask(QObject):
    ...
    def run(self, app_ids=None):
        ...
        try:
            ...
            if accela_username:
                command.extend(["--login", accela_username])
