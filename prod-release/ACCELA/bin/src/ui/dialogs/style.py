...
class StyleDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.layout.addLayout(color_group)
        ...
        self.layout.addWidget(self.ignore_color_warnings_checkbox)
        ...
        current_font.setPointSize(int(self.settings.value("font-size", 10)))
        ...
        self.layout.addLayout(font_group)

        # Titlebar position setting
        self.titlebar_position_checkbox = QCheckBox("Move Titlebar to Top")
        titlebar_top = self.settings.value("titlebar_position", "bottom", type=str) == "top"
        self.titlebar_position_checkbox.setChecked(titlebar_top)
        self.titlebar_position_checkbox.setToolTip("Move the titlebar from the bottom to the top of the window.")
        self.titlebar_position_checkbox.stateChanged.connect(self.on_titlebar_position_changed)
        self.layout.addWidget(self.titlebar_position_checkbox)
        ...
        self.layout.addWidget(self.gif_display_checkbox)
    ...
    def on_titlebar_position_changed(self, state):
        ...
        position = "top" if state == 2 else "bottom"  # 2 = checked, 0 = unchecked
